...
import { getMusician, updateMusician } from '../functions/endpoints/musician';

export class ProfileUpdateScreen extends PureComponent {
    state = {
        nameSurname: '',
        nickname: '',
        instrument: 'guitar',
    ...
    componentDidMount() {
     ...
     update = () => {
         updateMusician(this.state, this.state.musicianId).then(
             (response) => {
                     ...
                     <View style={{ padding: 15 }}>
                         ...
                         <View style={{ width: '100%' }}>
                             ...
                             <CustomButton
                                 text='UDATE PROFILE'
                                 buttonColor='green'
                                 onPress={() => this.update(this.state)}
